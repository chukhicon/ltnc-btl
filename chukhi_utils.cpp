...
void HandleHelpButton(SDL_Event* e, SDL_Rect& gBackButton, Button& HelpButton, Button& BackButton,
...
void DrawEndGameSelection(LTexture gLoseTexture, SDL_Event* e, SDL_Renderer* gRenderer,
